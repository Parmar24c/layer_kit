...
class FileDownloader {
  ...
  static Future<void> download({required String downloadUrl, FileDownloadFolder? folder, required String fileName}) async {
    ...
    final fileNamePath = "${folder ?? FileDownloadFolder.miodealSeller.title}/$fileName ${dateTime.millisecondsSinceEpoch}.$extension";
    ...
    try {
      await Di.sl<DioClient>().download(downloadUrl, fileSavePath, onReceiveProgress: ((count, total) async {
